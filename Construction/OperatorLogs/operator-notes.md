...
### Fixed percentage-of-canvas coordinates are not stable draw-test targets — several floating UI chips dock at different screen positions depending on session/venue state
