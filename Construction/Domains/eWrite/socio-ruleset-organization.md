...
- **Quickstart**: Grant's "Socio-: The Locked Courtyard & Beyond" —
  cleaned from `Construction/Domains/eWrite/manuscript/Socio-_ The Locked Courtyard
...
- **Niava**: Grant's "Niava Setting Supplement" — copied byte-for-byte
  verbatim from `Construction/Domains/eWrite/manuscript/Niava Setting Supplement.md`
  into `backend/internal/ewrite/seed/niava-v1.md`. No blank headings, no
  explicit anchors, no cleanup needed.

The original files in `Construction/Domains/eWrite/manuscript/` are Grant's
