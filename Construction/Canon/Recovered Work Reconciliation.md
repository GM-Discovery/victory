...
**Companion:** `Construction/Canon/Everything Implemented.md` answers what exists. This document reconciles historical unfinished intent to the smallest current release set.
...
- Historical reconciliation: `Construction/Canon/current-state.md`, `OperatorLogs/kernel-history-reconciliation-through-83.md`, reportbacks K71, K73–77, K79–86A, and kernel specs K69–86A.
