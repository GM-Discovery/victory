(function (root, factory) {
  ...
  root.VictoryStageSocketController = factory();
  ...
  function createSocketController(deps = {}) {
    ...
    function connectSocket() {
      ...
      ws = new WebSocketCtor(`${protocol}//${getLocation().host}/ws/${(globalThis.VictoryStageVenue || {}).slug}`);

      ws.addEventListener("open", () => {
        socketReconnectDelay = 1000;
        setStageStatus("Connected to the stage WebSocket.");
