...
func StoreUpdateToken(ctx context.Context, pool *pgxpool.Pool, req TokenUpdateRequest) (*StoredAction, error) {
	...
	payload := map[string]any{
		...
		"asset_shape":         updatedData["asset_shape"],
		"asset_type":          updatedData["asset_type"],
		"asset_status":        updatedData["asset_status"],
		"asset_content_url":   updatedData["asset_content_url"],
		"asset_thumbnail_url": updatedData["asset_thumbnail_url"],
		"default_grid_width":  updatedData["default_grid_width"],
		"default_grid_height": updatedData["default_grid_height"],
		"retain_original":     updatedData["retain_original"],
