# Socio-: The Locked Courtyard & Beyond {#socio-:-the-locked-courtyard-&-beyond}


## A Complete Starter Guide to Stories of Us in the World of Niava {#a-complete-starter-guide-to-stories-of-us-in-the-world-of-niava}
...
## *Written and designed by Grant Murray (GM Discovery)* For more: [github.com/GM-Discovery](https://github.com/GM-Discovery) License: CC-BY 4.0 unless otherwise stated. {#written-and-designed-by-grant-murray-(gm-discovery)-for-more:-github.com/gm-discovery-license:-cc-by-4.0-unless-otherwise-stated.}

# PART I: THE LOCKED COURTYARD {#part-i:-the-locked-courtyard}

*Learn the Game Through Story*

## Book Blurb (Read First) {#book-blurb-(read-first)}
...
**Don't read these instructions to players.** This module is written for someone that's never played a TTRPG before. It is suggested you read at least the first page through the end of the 

**What's Beyond the Door** section before running the game.

---


## Opening: Setting the Scene {#opening:-setting-the-scene}
...
**Narrator Decision Point:** You must now decide how you want to play the game. Players can take the characters presented at the end of this scenario and pass out pre-generated character sheets. Or you can read the core rules Chapters 1 \- 4 to have players make their own characters. Once you have completed character selection, you should continue to **🛍️ The Courtyard Marketplace** to help give equipment to the characters.
...
You don't need to explain everything upfront—just let them try things. This courtyard is your practice arena. The setting of the courtyard is intentionally vague if you want to play the tutorial then your own story leaving a “sci-fi cantina” or a “bronze-age market” it is likely history or the future has a place like the Courtyard Marketplace you can enter your own world from.

**Teaching Note:** See the core rulebook section on the Goldilock’s Complexity   
(Socio- Core Rulebook **page 11**).

The game does not expect you to know all the rules, or even use them all immediately. Use the rules your players rely on, and add supporting rules as needed. For example, if you’re not using combat, the rules about might and HP are likely unnecessary. If you want little crunch, play in character and follow your character’s drives and motivations. When you want the crunch, consult the books. 

**Important Note**: Tell your table what level of complexity you want during session zero  
discussions, especially if you’re expecting crunch.

---

## The Courtyard Marketplace {#the-courtyard-marketplace}
...
>   
> **If the players try to steal, cheat, or deceive her and fail**, she will escalate to draw public attention. Not violence, but sharp words, and loud accusations.

---

### Narrator Tips for Playing Kessa

- **Let her breathe.** She doesn't rush to conclusions. She wants to know who you are before she opens up.  
...
>   
> **Kessa is a flexible roleplay hub.** She can introduce economy, backstory, relationships, or unexpected help—depending on how the players treat her.
...
## What's Behind the Door {#what's-behind-the-door}
...
> **To attempt something uncertain, roll your skill die.** If the result meets or exceeds the Target Value (TV), you succeed. If not, you fail—but failure is part of the story.  
>   
...
## Social Conflict: Understanding Stances {#social-conflict:-understanding-stances}

> **The figure approaching you has taken a Command stance**—assertive, authoritative, expecting compliance. In Socio-, when stakes are high and words matter, every participant chooses a Social Stance before speaking or acting.  
>   
...
*"You're not angry about the door. Something else is going on."*
...
## Ra – The Guard at the Gate {#ra---the-guard-at-the-gate}
...
- **Repeated pressure (\~7 hard pushes)** → He panics, calls for backup, and shifts the scene toward group tension (but not violence unless escalated heavily).

**If asked directly about the door:**

> *"Oh, that? I locked it. Had to use the restroom. Didn't want y'all disappearing before I got back."*
...
# PART II: WELCOME TO NIAVA {#part-ii:-welcome-to-niava}

*The World Beyond the Door*

---

## Beyond the Door Lies Niava... {#beyond-the-door-lies-niava...}
...
## The Society Beyond the Mists: Rituals of Identity and Being {#the-society-beyond-the-mists:-rituals-of-identity-and-being}
...
#### Ritual Tags and Legacy Outcomes
...
The guest eats, then—when ready—asks the hosts in return.
...
**Life Stage:** Any (Performed annually, usually near one's birthdate)
...
# Geography of Niava {#geography-of-niava}
...
## Major Nations & Powers {#major-nations-&-powers}

### The Dorian Reach (Unified Northern & Central Talons)
...
## The Crown Bet: Ra's Challenge Explained {#the-crown-bet:-ra's-challenge-explained}
...
- **Martial:** Challenge or defeat the king in combat  
- **Strategic:** Complete a quest for the king to earn the crown  
- **Political:** Find a way to succeed the king legitimately  
...
1. Entwined Fate (Preconception) Your souls are linked beyond reason. You feel what they feel. Trait – “Thread Unbroken” Spend 1 Fate Point: Once per session, if this bondmate is in danger, you may roll as if present, using your own skill. Success affects them as if they succeeded.  
     
2. Blood Bond (Genetics) You are of the same blood—family by birth, pact, or magic. Trait – “What Flows in You, Flows in Me” Spend 1 Fate Point: When they take HP damage, absorb half of it, then gain \+1 TV on any action aiding or avenging them this scene.  
     
3. Shared Caretaker (Early Childhood) You were both raised by the same hands, and you remember what they taught. Trait – “Echo of a Lesson” Spend 1 Fate Point: When facing moral doubt, trauma, or a difficult choice, you may declare what the caretaker would have said. All who agree gain 1 HP or remove 1 status.  
     
4. Sibling Rivalry (Childhood) Everything was a contest. You made each other better or bitter. Trait – “Petty Edge” Spend 1 Fate Point: If they succeed at something and you witness it, gain \+2 TV on your next similar roll out of pride, spite, or competitive spirit.  
     
5. Found Family (Early School) You chose each other, when others didn’t. You belong. Trait – “I’ve Got You” Spend 1 Fate Point: Automatically succeed on a Support or Cover action for this bondmate, even across distance, once per scene.  
     
6. Lost Bond (Middle School) They’re gone now by death, betrayal, or silence... but you carry their shadow. Trait – “Haunted By Their Voice” Spend 1 Fate Point: When the moment reminds you of them, reroll any action. If you succeed, you may narrate a vision, echo, or memory they leave behind.  
     
7. Academic Rival (Upper School) You clashed in intellect or ability, always trying to outdo the other. Trait – “Razor Focus” Spend 1 Fate Point: When this bondmate is watching or competing with you, gain \+1 Intellect Tier or \+2 TV on any research, strategy, or planning task.  
     
8. Coming of Age Pact (Teen/Middle) You made a promise in youth that still binds you, even now. Trait – “Sworn to the Moment” Spend 1 Fate Point: When fulfilling your shared vow, succeed at any action as though you rolled max on your skill die. Narrator determines consequences.  
     
9. Project Partner (High School) You built something together—an idea, a dream, a memory. Trait – “Built to Last” Spend 1 Fate Point: If working on the same task or goal, both you and your bondmate roll with advantage. You may also restore 1 spent Helper between you.  
     
10. Life Path Ally (Young Adult) They’ve walked with you on your chosen road, through change and choice. Trait – “Witness to Becoming” Spend 1 Fate Point: When this bondmate sees you succeed on a major milestone, gain 1 additional Fate Point, or refresh 1 spent bond.

Usage Summary Bond traits are purchased with Fate Points (suggested cost: 1–2 FP each).
...
## The Bread Standard (Economy in Niava) {#the-bread-standard-(economy-in-niava)}
...
Ten years before the present timeline, the Bread Standard is being piloted by a small island nation within the Turtle continent. Its emergence signals a transition from **scarcity-based economics (Gold Standard)** to a model that centers **human dignity, sufficiency, and creative autonomy**.
...
# PART III: CULTURAL DEPTH {#part-iii:-cultural-depth}
...
## Nianic Primer: The Language of Being {#nianic-primer:-the-language-of-being}
...
## Word Structure: How to Build a Nianic Word {#word-structure:-how-to-build-a-nianic-word}
...
## Emotional Vowels (Glides) {#emotional-vowels-(glides)}

In Nianic, **vowels carry emotion**. They are not decorative—they *define the emotional state* of the verb. Each verb root (e.g., `-nia`, `-tia`, `-zia`) is **inflected** by the vowel at its center.
...
# Economics: The Gold Standard {#economics:-the-gold-standard}
...
**Helper cards activate before the main social roll** \- the helper must succeed first, then their bonus applies to the primary actor. Failed helpers often make NPCs more suspicious or defensive, increasing difficulty instead of helping.

While your players are learning the game, skill caps keep things limited. A 1-5 scale is sufficient for players to roll either a d4 if they don’t have the skill, or a d6 if they’ve trained in it.

**After the tutorial, keep Target Values around 8-12** for normal challenges, add \+1-3 for each additional helper due to coordination complexity. NPCs can change stances between rounds as conversations evolve. Let the dice and player creativity drive outcomes; critical successes might create lasting positive relationships, while critical failures create reputation effects or social complications.
...
| Fashionable Tier 4 | 1,000 | 1,001,000 | $1,000.00 | \+1 Presence for bonuses, \-4 TV on Presence attempts |
...
| Noble’s Signet Ring | 200 | 40,200 | $20,000.00 | Grants authority in specific domains |
...
| ----- | ----- | ----- | ----- | ----- | ----- |
| Cotton Padding | 8 | 72 | $8.00 | 1 | Light, no movement penalty |
...
| Splint Armor | 180 | 32,580 | $3,250.00 | 7 | Metal strips on leather |
...
| Tower Shield | 120 | 14,520 | $1,500.00 | — | \+3 to Dodge, provides cover |
| Helmet, Basic | 25 | 650 | $78.50 | — | \+1 damage reduction to head |
| Helmet, Great | 80 | 6,480 | $650.00 | — | \+2 damage reduction, vision penalty |

---

| Item | Cost | Cost at 1 Wealth | USD Cost | Damage | Special | Tags |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- |
| Knife | 5 | 30 | $30.50 | d4 | Concealable, utility | Slashing, Throwable |
...
| Longsword | 80 | 6,480 | $500.00 | d8 | Balanced | Slashing, Versatile |
| Scimitar | 70 | 4,970 | $350.00 | d8 | Curved, swift | Slashing, Swift |
...
| Masterwork Blade | \+300 | \+90,300 | \+$10,300.00 | d12+1d4 | Superior craftsmanship | Masterwork |


## **Weapons – Blunt** {#weapons---blunt}

| Item | Cost | Cost at 1 Wealth | USD Cost | Damage | Special | Tags |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- |
| Club | 2 | 6 | $6.00 | d4 | Simple | Crushing, Improvised |
...
## **Weapons – Polearms** {#weapons---polearms}
...
| Crossbow | 120 | 14,520 | $12.00 | d10 | Mechanical | Ranged, Armor Piercing |
| Heavy Crossbow | 200 | 40,200 | $20.00 | d12 | Siege | Ranged, Two-Handed |
| Throwing Knife | 8 | 72 | $0.80 | d4 | Concealable | Thrown, Stealth |
| Javelin | 15 | 240 | $1.50 | d6 | Thrown spear | Thrown, Piercing |
| Arrows (20) | 5 | 30 | $0.50 | — | Ammunition | Consumable |
| Bolts (20) | 8 | 72 | $0.80 | — | Ammunition | Consumable |

---


## **Tools & Professional Equipment** {#tools-&-professional-equipment}

| Item | Cost | Cost at 1 Wealth | USD Cost | Effect |
| ----- | ----- | ----- | ----- | ----- |
| Artisan’s Tools | 50 | 2,550 | $5.00 | Required for Craft skills, \+1 |
| Smith’s Hammer | 25 | 650 | $2.50 | \+1 to metalwork |
| Thieves’ Tools | 80 | 6,480 | $8.00 | \+2 to lockpicking |
| Healer’s Kit | 45 | 2,070 | $4.50 | 10 uses |
| Scholar’s Kit | 60 | 3,660 | $6.00 | \+1 to Research |
| Climbing Gear | 35 | 1,260 | $3.50 | \+2 to Climbing |
| Survival Kit | 40 | 1,640 | $4.00 | \+1 to Survival |
| Musical Instrument | 30–200 | 930–40,200 | $3–$20 | Required for Performance |
| Magnifying Glass | 80 | 6,480 | $8.00 | \+2 to Search |
| Telescope | 150 | 22,650 | $15.00 | \+3 to Observation |
...
| Item | Cost | Cost at 1 Wealth | USD Cost | Effect |
| ----- | ----- | ----- | ----- | ----- |
| Backpack | 8 | 72 | $0.80 | Carry more |
| Bedroll | 3 | 12 | $0.30 | Rest comfort |
| Rope (50 ft) | 10 | 110 | $1.00 | Utility |
| Silk Rope (50 ft) | 50 | 2,550 | $5.00 | Quiet, light |
| Torch | 1 | 2 | $0.10 | 1 hour light |
| Lantern | 15 | 240 | $1.50 | Requires oil |
| Oil (1 flask) | 2 | 6 | $0.20 | Fuel |
| Rations (1 day) | 2 | 6 | $0.20 | Sustenance |
| Waterskin | 3 | 12 | $0.30 | 1 day water |
| Tent, Small | 25 | 650 | $2.50 | 2 people |
| Tent, Large | 60 | 3,660 | $6.00 | 6 people |
| Winter Blanket | 12 | 156 | $1.20 | \+1 cold Survival |

---


## **Luxury & Specialty Items** {#luxury-&-specialty-items}

| Item | Cost | Cost at 1 Wealth | USD Cost | Effect |
| ----- | ----- | ----- | ----- | ----- |
| Spyglass | 200 | 40,200 | $20.00 | \+4 sea navigation |
| Silk Clothing | 100 | 10,100 | $10.00 | \+1 exotic interactions |
| Fine Jewelry | 500 | 250,500 | $50.00 | \+2 wealth displays |
| Exotic Perfume | 80 | 6,480 | $8.00 | \+1 first impressions |
| Masterwork Instrument | 400 | 160,400 | $40.00 | \+1d4 Performance |
| Blessed Holy Symbol | 150 | 22,650 | $15.00 | \+1 Faith |
| Spell Component Pouch | 120 | 14,520 | $12.00 | Required for magic |
| Crystal Ball | 800 | 640,800 | $80.00 | \+3 divination |
| Magic Scroll | 300 | 90,300 | $30.00 | Single-use |
| Potion of Healing | 50 | 2,550 | $5.00 | Restore 1d6 HP |

---


## **Mounts & Animals** {#mounts-&-animals}

| Item | Cost | Cost at 1 Wealth | USD Cost | Effect |
| ----- | ----- | ----- | ----- | ----- |
| Riding Horse | 200 | 40,200 | $20.00 | \+3 travel |
| War Horse | 800 | 640,800 | $80.00 | \+2 mounted combat |
| Pony | 100 | 10,100 | $10.00 | \+2 mountain travel |
| Mule | 80 | 6,480 | $8.00 | Heavy loads |
| Ox | 120 | 14,520 | $12.00 | Farming |
| Hunting Dog | 60 | 3,660 | $6.00 | \+2 Tracking |
| Guard Dog | 40 | 1,640 | $4.00 | \+1 Vigilance |
| Falcon | 150 | 22,650 | $15.00 | Messenger |
...
| Item | Cost | Cost at 1 Wealth | USD Cost | Effect |
| ----- | ----- | ----- | ----- | ----- |
| Inn Stay (night) | 2 | 6 | $0.20 | Room \+ meal |
| Tavern Meal | 1 | 2 | $0.10 | Social |
| Stable Mount | 1 | 2 | $0.10 | Safekeeping |
| Hire Guide | 10/day | 110/day | $1/day | \+3 Navigation |
| Messenger | 5 | 30 | $0.50 | City delivery |
| Scholar Consultation | 20 | 420 | $2.00 | \+2 Lore |
| Map, Local | 15 | 240 | $1.50 | \+1 Navigation |
| Map, Regional | 50 | 2,550 | $5.00 | \+2 Navigation |
| Rumors | 5–50 | 30–2,550 | $0.50–$5 | Variable |
| Safe Passage Papers | 100 | 10,100 | $10.00 | Legal travel |

---


## **Magical Items (If Available)** {#magical-items-(if-available)}

| Item | Cost | Cost at 1 Wealth | Effect |
| ----- | ----- | ----- | ----- |
| Ring of Protection | 2,000 | 4,002,000 | \+1 defense |
| Cloak of Elvenkind | 1,500 | 2,251,500 | \+3 Stealth |
| Boots of Speed | 1,800 | 3,241,800 | \+2 movement |
| Bag of Holding | 3,000 | 9,003,000 | Unlimited carry |
| Wand of Magic Missiles | 2,500 | 6,252,500 | 20 charges |
| Greater Healing Potion | 150 | 22,650 | Restore 2d6 HP |
| Potion of Strength | 100 | 10,100 | \+2 Might |
| Scroll of Fireball | 200 | 40,200 | Area damage |
| Enchanted Weapon \+1 | \+2,000 | \+4,002,000 | \+1d4 damage |
| Amulet of Truth | 1,200 | 1,441,200 | \+3 lie detection |

---


## **Contraband & Black Market** {#contraband-&-black-market}

| Item | Cost | Cost at 1 Wealth | Effect |
| ----- | ----- | ----- | ----- |
| Basic Poison | 80 | 6,480 | Ongoing damage |
| Lethal Poison | 300 | 90,300 | Potentially fatal |
| Forgery Kit | 150 | 22,650 | \+2 forgery |
| Disguise Kit | 100 | 10,100 | \+2 disguise |
| Smoke Bomb | 20 | 420 | Concealment |
| Flash Powder | 25 | 650 | Blind 1 round |
| Master Lock Picks | 200 | 40,200 | \+3 lockpicking |
| Stolen Goods Fence | 50% value | 50% value | Convert to gold |
| Bribe Money | Variable | Variable | \+2–5 Corruption |
| False Identity Papers | 500 | 250,500 | New identity |
...
| Item | Cost | Cost at 1 Wealth | Effect |
| ----- | ----- | ----- | ----- |
| Fresh Bread | 0.5 | 0.75 | Sustenance |
| Cheese Wheel | 8 | 72 | Long-lasting |
| Smoked Meat | 12 | 156 | Preserved |
| Common Wine | 3 | 12 | \+1 casual social |
| Fine Wine | 25 | 650 | \+2 formal |
| Ale (pint) | 0.5 | 0.75 | Tavern staple |
| Strong Spirits | 15 | 240 | \+1 Intimidation, \-1 Precision |
| Exotic Spices | 50 | 2,550 | \+1 Cooking |
| Medicinal Tea | 10 | 110 | \+1 recovery |
| Coffee | 20 | 420 | \+1 alertness |
...
Full skill descriptions, advancement systems, and expanded mechanics are available free at **\[https://www.github.com/gm-discovery/socio-\]**

## Character Growth {#character-growth}

Your characters can develop beyond their starting abilities through the core progression system

## Campaign Building {#campaign-building}

Find world-building tools, additional scenarios, and GM resources in the complete rulebooks

## Community {#community}

Connect with other players and share your stories

---

## **Keep Playing** {#keep-playing}

The locked courtyard was just your first challenge. Beyond Ra's door lies the entire world of Niava—with its fractured Turtle continent kingdoms, the experimental Bread Standard society, the corporate networks of Trand, and the warrior cultures of the Claw.

Where will your characters go next? Will they chase the Crown bet and make their mark in the Games? Will they help build the new society Beyond the Mists? Will they navigate the complex politics of three continents in conflict?

The choice is yours \- and now you have the tools, the world, and the cultural depth to make those choices matter.

**Your adventure in Niava is just beginning.**  
